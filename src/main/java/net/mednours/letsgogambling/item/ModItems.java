...
public class ModItems {
    ...
    public static final Item STONE_COIN = registerItem("stone_coin", new Item(new Item.Settings()));
    public static final Item WOOD_COIN = registerItem("wood_coin", new Item(new Item.Settings()));
